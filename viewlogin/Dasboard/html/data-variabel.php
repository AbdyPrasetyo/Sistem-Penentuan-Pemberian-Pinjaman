                    ...
                    <div class="card-body">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="../html/crudvariabel/create-variabel.php" method="POST">
                                                <label for="input1">Input Nama Variabel</label>
                                                <input class="form-control" type="text" name="variabel">
                        ...
                        <div class="table-responsive">
                            <table class="table user-table">
                                ...
                                <tbody>
                                    <?php require_once('../html/crudvariabel/view-variabel.php'); ?>
                                </tbody>
                            </table>
                        </div>
                    </div>
